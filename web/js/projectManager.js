...
//Toasts
const toastJoinProjectEx = document.getElementById("toastJoinProjectEx");
const toastJoinProjectNe = document.getElementById("toastJoinProjectNe");
...
function validUser() {
    $.ajax({
        url: "ProjectJoinValidate", 
        data: {
            inputAccessCode: $("#inputAccessCode").val()
        },
        type: "POST",
